...
# model2 (including the months up to August)
...
# model3 (including the months up to July)
summary(train.data$PAY_Jul)
...
# model4 (including the months up to June)
banklogit5.reg <- glm(default.payment.next.month ~ LIMIT_BAL + SEX + EDUCATION + MARRIAGE + AGE+
                     ...
                     data = train.data, family = "binomial") 
# model5 (including the months up to May)
